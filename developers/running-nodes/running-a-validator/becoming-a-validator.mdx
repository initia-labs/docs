...
<Note>
  ...
  is fully synced to the latest height. You can verify this by comparing the latest
  block height of your node with those of the network.
</Note>
...
If the command returns something, your validator is active and is actively
proposing and signing blocks.
