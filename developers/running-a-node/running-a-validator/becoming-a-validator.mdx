...
<Note>
Only the top 130 validators in voting power are included in the active validator set. This means that even if you `CreateValidator` transaction passes, your validator might not be active until it has sufficient delegations.
</Note>
