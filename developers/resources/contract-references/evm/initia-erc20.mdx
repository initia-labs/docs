...
<Warning>
The InitiaERC20 contract is only meant to be used by the [ERC20Factory](/developers/resources/contract-references/evm/erc20-factory) contract. It is not meant to be used directly and does not have the necessary modifiers for full compatibility with the MiniEVM.

To deploy a custom ERC20 token, developers should use the [InitiaCustomERC20](/developers/resources/contract-references/evm/initia-custom-erc20) contract instead.
</Warning>
