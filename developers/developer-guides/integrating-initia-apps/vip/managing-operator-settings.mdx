...
The operator is the account you specify during VIP whitelisting and receives your rollup's operator commission. Operator commission is a fixed percentage of the rollup's total VIP reward. For details, see [distribution to rollup operators](/home/core-concepts/vip/architecture#distribution-to-rollup-operators). 
