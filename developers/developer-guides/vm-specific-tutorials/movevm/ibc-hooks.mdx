...
```bash
curl -X GET "https://lcd.initiation-1.initia.xyz/initia/ibchooks/v1/acls" -H "accept: application/json"
```
...
async function main() {
  const l1lcd = new LCDClient('https://lcd.initiation-1.initia.xyz', {
      gasAdjustment: '1.75',
      gasPrices: '0.15uinit'
  })
