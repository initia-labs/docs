...
MiniEVM currently does not support EIP-1559 transactions. This means that if you are using Foundry to deploy your contracts, you will need to use the `--legacy` flag whenever you send transactions to the MiniEVM.
