...
Next, extend the `InitiaCustomERC20` contract and add the constructor
to initialize the contract with the name, symbol, and decimals of your custom
ERC20. For this tutorial, you will simply customize the base contract by adding a
...
Now replace the contents of the `NewInitiaERC20.t.sol` file with the
...
accomplish this, use Foundry's `forge create` command
