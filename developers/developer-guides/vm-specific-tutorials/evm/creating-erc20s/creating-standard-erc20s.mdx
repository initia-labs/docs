...
<Note>
You can find the address of the ERC20Factory contract on the different in the [Networks](/resources/developer/networks) page, or by calling the `/minievm/evm/v1/contracts/erc20_factory` endpoint of any MiniEVM rollups node.
</Note>
