...
For developers looking to create standard ERC20 tokens on EVM Minitias, we recommend using the [ERC20Factory](/resources/developer/contract-references/evm/erc20-factory) contract.
...
<Note>
You can find the address of the ERC20Factory contract on the different in the [Networks](/resources//developer/networks) page, or by calling the `/minievm/evm/v1/contracts/erc20_factory` endpoint of any MiniEVM Minitia node.
</Note>
