...
[ERC20Factory](/resources/developer/contract-references/evm/erc20-factory)'s `createErc20` function. Tokens created via this method are
fully compatible with the chain and Initia's core products by default.
