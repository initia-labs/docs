...
contract. Tokens created via this factory use the
[ERC20](/resources/developer/contract-references/evm/erc20) contract and are
fully compatible with the chain and Initia's core products.
