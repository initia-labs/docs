...
Next, initialize the project and create an `index.js` file in a `src`
directory.
...
`0x5E5f1a92eECA58053E8364630b66763aa6265Ab0` that you want to convert to a Cosmos
coin denom, and then convert it back to an ERC20 token address.

First, initialize the variable for the chain's REST endpoint and the ERC20
token address.
...
To convert a Cosmos coin denom back to an ERC20 token address, use
