  ...
  "messages": [
    ...
    },
    {
      ...
      "params": {
        ...
        "allow_custom_erc20": true, // Whether to allow custom ERC-20 tokens
        "allowed_custom_erc20s": [], // Whitelisted custom ERC-20 contracts
        "fee_denom": "umin", // Fee denomination used by EVM
        "gas_refund_ratio": "0.500000000000000000", // Refund ratio on unused gas
        "num_retain_block_hashes": "256" // Number of recent block hashes to retain
      }
    }
  ]
}
