...
async function main() {
    ...
    const tokenPair = await restClientL1.ophost.tokenPairByL1Denom(2, "uinit") // { l1_denom: 'uinit', l2_denom: 'l2/2588fd87a8e081f6a557f43ff14f05dddf5e34cb27afcefd6eaf81f1daea30d0' }
    ...
    await restClientL1.tx.broadcastSync(signedTx).then(res => console.log(res));
}
