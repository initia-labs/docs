...
In Initia's case, Slinky prices can also be relayed from the Initia L1 to any minitia through the minitia's [Bridge Executor](/developers/full-architecture/opinit-stack/opinit-bots/bridge-executor). This eliminates the need for minitia teams to spend resources and time finding and integrating their own oracle provider.