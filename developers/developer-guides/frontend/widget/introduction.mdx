...
- It uses the widely adopted [wagmi](https://wagmi.sh/) library. Therefore, users can [send transactions via JSON RPC through wagmi](https://www.notion.so/Integration-EVM-24786c34856f8141870bf602dbc0abb7?pvs=21) instead of the provided interface or [choose to use RainbowKit for wallet connection](https://www.notion.so/Integration-RainbowKit-24786c34856f81efa9cbec0c6a8da9af?pvs=21).
