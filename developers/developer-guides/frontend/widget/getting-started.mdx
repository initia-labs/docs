...
Following the steps above is enough to configure and use Initia Wallet. For more advanced use cases, refer to the following:

- [Integration EVM](https://www.notion.so/Integration-EVM-24786c34856f8141870bf602dbc0abb7?pvs=21)
- [Integration RainbowKit](https://www.notion.so/Integration-RainbowKit-24786c34856f81efa9cbec0c6a8da9af?pvs=21)
- [InterwovenKitProvider](https://www.notion.so/Reference-InterwovenKitProvider-24786c34856f81139ac6c440d87ad86f?pvs=21)
- [useInterwovenKit](https://www.notion.so/Reference-useInterwovenKit-24786c34856f817f8c97eeb08ce524b4?pvs=21)