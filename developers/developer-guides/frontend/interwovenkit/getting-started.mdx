...
The app will be available at [http://localhost:3000](http://localhost:3000/). Alternatively, you can manually integrate Initia Wallet into your existing project.
...
- [Integration with EVM](./integration/evm)
- [Integration with RainbowKit](./integration/rainbowkit)
