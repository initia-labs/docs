...
<Warning>
Please note that by default, Weave collects non-identifiable usage data to improve the product. If you do not want to share this data, you can opt out by running the following command:
```bash
