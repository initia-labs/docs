...
1. **Infrastructure Management:** Weave can handles all critical infrastructure
...
3. **Developer Experience:** Not only it consolidates multiple complex
...
3. **Simple service management:** Weave provides a simple command to start,
   ...
   In essence, every infra-service you setup can be managed with the following
   commands:
