...
title: Introduction
description:
  Learn how to install and get started with the initiad command-line interface
...
<Tab title="Testnet">
  ```bash # Get the current testnet version and checkout export VERSION=$(curl
...
<Tab title="Testnet">
  ```bash initiad config chain-id initiation-1 initiad config node
...
<Card
  ...
  href="/developers/developer-guides/tools/clis/initiad-cli/querying-data"
>
