...
In Initia's case, Slinky prices can also be relayed from the Initia L1 to any minitia through the minitia's [OPinit Bot](/initia-and-minitias/technical-architecture/opinit-framework/components/introduction.mdx). This eliminates the need for minitia teams to spend resources and time finding and integrating their own oracle provider.
