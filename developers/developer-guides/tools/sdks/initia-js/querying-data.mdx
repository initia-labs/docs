...
For demonstration purposes, assume that all of these examples are
...
Next, create a function to query the balance of an account. This
...
next page of results. Then keep looping through the results until you
have all the pages, which you will know is the case when `next_key` is `null`.
