...
You can use the Initia LCDClient to get on-chain data using a variety of helper functions. Here’s an example showing how to fetch common data you may need in your application.
...
<Note> Adjust gasPrices and gasAdjustment according to current network conditions for optimal transaction processing. </Note>
