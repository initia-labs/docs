...
<CardGroup>
  <Card
    ...
    icon="wallet"
    href="/developers/developer-guides/frontend/interwovenkit/integrations/native">
    Set up InterwovenKit as the default wallet connection option for your application
  </Card>
  <Card 
    title="EVM Integration" 
    icon="ethereum"
    href="/developers/developer-guides/frontend/interwovenkit/integrations/evm">
    Integrate InterwovenKit with an existing EVM application
  </Card>
  <Card
    title="RainbowKit Integration"
    icon="rainbow"
    href="/developers/developer-guides/frontend/interwovenkit/integrations/rainbowkit">
