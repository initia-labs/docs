...
The portfolio now displays Strat perpetual futures positions and vault deposits alongside existing staking,
liquidity, and lending positions. Perp positions show the market pair,
direction (long or short), leverage, posted margin, and unrealized P&L. Vault
deposits are shown as flat entries without a staking-style rewards breakdown.
