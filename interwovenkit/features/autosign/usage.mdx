...
can confirm the autosign setup and select an expiration duration.
...
Users can disable autosign at any time. This revokes all grants and prevents
further automatic signing.
