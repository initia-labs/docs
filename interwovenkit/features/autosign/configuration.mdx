...
1. Wraps your app with `PrivyProvider` to enable authentication and embedded wallet management.
2. Uses Privy hooks (`usePrivy`, `useLoginWithSiwe`, `useCreateWallet`, `useWallets`) to access wallet and auth state.
