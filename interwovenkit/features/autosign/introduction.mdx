...
application. When autosign is enabled, InterwovenKit creates a ghost wallet
...
- **Managed Automatically**: InterwovenKit handles key management and wallet lifecycle
