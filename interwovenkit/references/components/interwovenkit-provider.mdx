...
- Font stylesheets are automatically injected
...
import { initiaPrivyWalletConnector, InterwovenKitProvider, MAINNET } from "@initia/interwovenkit-react"
...
- For AutoSign and Privy integration setup, see [Provider Setup](../setup/providers)
