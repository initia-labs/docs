...
<Note>
This example shows the provider structure. For complete setup including `injectStyles` and AutoSign configuration, see [Provider Setup](../setup/providers).
</Note>
...
<Note>
This example shows only the `InterwovenKitProvider` configuration. For complete provider setup including `QueryClientProvider`, `WagmiProvider`, and `injectStyles`, see [Provider Setup](../setup/providers).
</Note>
