...
- CSS styles must be injected manually using [`injectStyles`](../utilities/inject-styles.mdx) once at app startup. Otherwise the UI will be unstyled
...
**Note:** This example shows the provider structure. For complete setup including `injectStyles` and AutoSign configuration, see [Provider Setup](../setup/providers.mdx).
...
**Note:** This example shows only the `InterwovenKitProvider` configuration. For complete provider setup including `QueryClientProvider`, `WagmiProvider`, and `injectStyles`, see [Provider Setup](../setup/providers.mdx).

### AutoSign configuration

AutoSign requires Privy integration. See [Provider Setup](../setup/providers.mdx) for the complete AutoSign setup with Privy.

### Privy integration

For Privy integration with AutoSign, see [Provider Setup](../setup/providers.mdx) for the complete example.
