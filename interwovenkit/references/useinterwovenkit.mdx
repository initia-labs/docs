...
<ParamField
  path="openBridge"
  type="(defaultValues?: Partial<BridgeFormValues>) => void"
>
...
<ParamField
  path="requestTxBlock"
  type="(txRequest: TxRequest) => Promise<DeliverTxResponse>"
>
...
<ParamField
  path="requestTxSync"
  type="(txRequest: TxRequest) => Promise<string>"
>
...
<ParamField
  path="submitTxBlock"
  type="(txParams: TxParams) => Promise<DeliverTxResponse>"
>
...
<ParamField
  ...
  type="(params: TxQuery) => Promise<IndexedTx>"
>
