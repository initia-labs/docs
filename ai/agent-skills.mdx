...
The Initia Appchain Dev skill is open source. If you find gaps in the skill's knowledge, incorrect guidance, or want to add coverage for new features, you can contribute directly:
