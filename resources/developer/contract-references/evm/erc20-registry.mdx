...
The `ERC20Registry` contract provides modifiers for registering ERC20 tokens and their associated stores. Registration allows the token to be recognized and made interoperable with other parts of the MiniEVM rollup functionality.
