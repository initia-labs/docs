...
The `InitiaCustomERC20` contract is a custom implementation of the ERC20 token standard. It includes additional access control mechanisms and registry functionalities to allow for better integration with the rollup's underlying Cosmos SDK stack.
