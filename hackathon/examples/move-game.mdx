...
```terminal wrap
Using the `initia-appchain-dev` skill, modify the Game.jsx component in the `blockforge-frontend` directory to connect to our blockforge contract on my appchain. Use the @initia/interwovenkit-react for wallet connection and transaction signing.
