...
```terminal title="Prompt: Create and test the MemoBoard contract" wrap
...
```terminal title="Prompt: Deploy the MemoBoard contract" wrap
...
```terminal title="Prompt: Smoke test the MemoBoard contract" wrap
...
```terminal title="Prompt: Scaffold the MemoBoard frontend" wrap
...
```terminal title="Prompt: Connect the frontend to the MemoBoard contract" wrap
...
```terminal title="Prompt: Add Initia username support" wrap
