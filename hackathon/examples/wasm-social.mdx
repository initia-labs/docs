...
<Tip>
  **Open the Frontend:** After scaffolding, `cd` into the `memoboard-frontend` directory and run `npm run dev` to start the application. Open the provided URL in your browser and connect your wallet extension.
