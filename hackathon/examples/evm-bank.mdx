...
**1. Get your Wallet Address:** Open your browser wallet and copy your EVM
address (it starts with `0x...`).
For CLI commands in this guide, use your bech32 Initia address (`init1...`)
...
**1. Find your bech32 address (`init1...`):** For CLI query calls, get your
