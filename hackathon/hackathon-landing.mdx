...
Now, ask your AI agent to handle the Initia-specific tools. It will install the core CLIs (`weave`, `initiad`, `jq`), build your chosen VM binary (`minitiad`), and ensure everything is in your `PATH`.
...
### 5.1 Verify Installation & PATH [AI agent]

After the setup completes, your AI agent can ensure the tools are accessible
...
Your AI agent is your partner in this hackathon, but the `weave` CLI
...
## Step 8: Verifying Your Appchain [AI agent]
