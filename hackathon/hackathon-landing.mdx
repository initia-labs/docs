...
<Warning>
  **Docker Desktop must be running.** Ensure it is active before installing or running tools. **[Download here](https://www.docker.com/products/docker-desktop/)**.
</Warning>
...
<Steps>
  ...
  <Step title="Rollup Identity">
    ...
    **Action:**
    ...
    <Warning>
      **Switching VMs?** You **must** reinstall the correct `minitiad` binary (Step 4.2) to override the previous one. If you have existing rollup data, type `confirm` to delete it and proceed.
    </Warning>
