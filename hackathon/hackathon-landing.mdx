...
## Build an Appchain with Your AI Co-pilot

Welcome to the hackathon! This guide will walk you through building an appchain
from scratch. You'll go from a simple idea to a functioning appchain with a
...
<Steps>
  ...
  <Step title="Security & Genesis">
    ...
    **Action:**
    ...
    <Note>
    If you are on the **Move track**, use `10000000000000000000` (10^19) instead, as Move balances are represented as `u64` and will overflow with larger values.
    </Note>
...
<CardGroup cols={3}>
  ...
  >
    Frictionless games with Auto-signing.
  </Card>
  <Card
    title="Interwoven Bridge (EVM)"
    icon="bridge"
    href="/hackathon/examples/evm-bank"
  >
    Native liquidity and cross-chain bridging.
  </Card>
  <Card
    title="Human Identity (Wasm)"
    icon="user-group"
    href="/hackathon/examples/wasm-social"
  >
    Identity-first apps with .init usernames.
  </Card>
</CardGroup>
