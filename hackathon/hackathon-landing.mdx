...
which `Virtual Machine (VM)` your AI assistant will set up for you.
...
## Step 5: AI-Powered Environment Setup

Now, ask your AI assistant to handle the Initia-specific tools. It will install the core CLIs (`weave`, `initiad`, `jq`), build your chosen VM binary (`minitiad`), and ensure everything is in your `PATH`.
...
### 5.1 Verify Installation & PATH [AI Assistant]

After the setup completes, your AI assistant can ensure the tools are accessible
