...
- [ ] **GitHub Repository**: Include a link to your public repository.
- [ ] **Submission JSON**: Create `.initia/submission.json` using the official schema.
- [ ] **Custom Implementation (Core Logic)**: Link to the specific smart contract/module file you built.
- [ ] **Power-Up (Interwoven Feature)**: Link to the frontend file implementing Auto-signing, Bridge, or Usernames.
- [ ] **L2 Interaction TX**: Include a transaction hash/link showing real user interaction on your appchain.
- [ ] **Demo Video URL**: Include a 1-3 minute walkthrough video (Loom/YouTube, public or unlisted).
- [ ] **Implementation Detail**: Briefly explain your custom logic, chosen power-up, and ecosystem value add.
