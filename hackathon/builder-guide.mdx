...
<Tip>
  **Save this early:** As you build, save your deployed contract or module
  address. You will need it when completing `.initia/submission.json`.
</Tip>
...
- **Supporting Evidence**: Ensure your JSON includes valid paths to your core logic file and native feature frontend file.
