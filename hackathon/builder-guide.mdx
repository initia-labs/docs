...
2.  **Build & Test**: Clearly describe your app's behavior and rules, then let
...
5.  **Frontend Integration**: Ask the AI to build or update your frontend and connect it to your appchain.
...
6.  **Native Feature Integration**: Ask the AI to implement one supported native feature and wire it into your app flow.
