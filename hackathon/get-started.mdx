...
## Step 11: Next Steps: Master the Workflow
...
**Build Your Project** will teach you the **Describe -> Build -> Test** loop using
your AI co-pilot, which is essential for building a winning hackathon entry.

[Go to Build Your Project ->](/hackathon/build-your-project)
