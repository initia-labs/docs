...
export const TargetRatio = "Defines the ideal proportion of IbcOpInit vs. INIT in the virtual pool. For example, an R_target of 0.6 implies that the ratio is 6:4. This value increases as B increases."
export const MaxRatio = "A governance-controlled value that defines the largest R_target value allowed."
