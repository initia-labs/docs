...
experience, designed to make onchain actions feel as smooth as browsing the
internet. Ghost Wallets function as temporary delegated wallets that allow for
auto-signing, which approved onchain transactions are executed on behalf of a
user’s main wallet.
...
all Initia app chains and supported Apps.
