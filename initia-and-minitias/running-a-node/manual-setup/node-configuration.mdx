...
- **`chain-id`** is the id of the chain you are joining. This can be found in the [Networks](/resources/developer/networks) section of the docs
...
Refer to the [Networks](/resources/developer/networks) section of the docs to find the `genesis-url` for the network you are joining.
