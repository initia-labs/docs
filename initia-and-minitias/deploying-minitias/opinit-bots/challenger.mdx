...
<Steps>
  ...
  <Step title= "Configuration">
    ...
    - `l2_start_height`: Challenger automatically sets the starting height for challenge processing. If set to 0, the bot will start from the latest block height.
  </Step>
