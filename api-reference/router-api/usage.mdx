...
not broadcast transactions. Your application signs and submits the transaction to the chain. This page walks through the full flow.
...
Because you sign and broadcast the transaction outside the Router API,
the API does not know about the transaction until you provide the transaction
hash. You must register the transaction before you can monitor its cross-chain
progress.
