...
The Router API supports cross-chain transfers from Initia Stack-based chains to external networks, automatically determining the optimal route across supported networks, chains, and DEXes.
