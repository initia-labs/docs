...
MiniMove is a [MoveVM](https://move-language.github.io/move)-based variant of Initia's rollup framework, designed to support the deployment of and interaction with MoveVM smart contracts.
