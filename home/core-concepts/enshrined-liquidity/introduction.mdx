...
aim to earn both rewards, you need to split your capital into multiple positions,
reducing your overall capital efficiency.

By using liquidity positions as staking assets, Enshrined Liquidity eliminates
the need to choose between staking and liquidity provision. You can now earn both
staking rewards and trading fees from a single position, leading to improved
capital efficiency and a streamlined approach to capital allocation.
