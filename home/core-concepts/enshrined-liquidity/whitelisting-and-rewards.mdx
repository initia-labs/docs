...
To be eligible for staking and earning rewards on InitiaDEX, an LP pair must be
whitelisted through L1 governance. Before whitelisting, the LP token must meet
...
distribution among all whitelisted tokens. This weight can be later adjusted by
governance once the asset is whitelisted..
