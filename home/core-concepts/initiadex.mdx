...
- [**Enshrined Liquidity**](/home/core-concepts/enshrined-liquidity/introduction.mdx): Optimizing liquidity and chain security through allowing whitelisted InitiaDEX liquidity positions to be used as staking assets for the Initia L1.
- [**Minitswap Pool Type**](/home/core-concepts/minitswap/introduction): A custom pool type designed to alleviate the friction and challenges posed by the long withdrawal times of [optimistic bridges](https://medium.com/connext/optimistic-bridges-fb800dc7b0e0).
