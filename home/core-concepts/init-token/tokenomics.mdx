...
| Enshrined Liquidity & Staking | 250M | 25.00% | 5% released per year on a block-by-block basis, with a slightly shortened schedule due to accelerated emissions in the first month |
