...
<Note>
For details on the specific [VIP parameters](/resources/developer/initia-l1#vip-parameters) such as stage and cycle duration, see the VIP Parameters section of the docs.
</Note>
