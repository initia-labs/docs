...
When creating a lock-staked position, you can choose the duration for locking
your LP position. The length of this lock determines your voting power on VIP
gauge votes. However, when lock-staking through VIP, a minimum lock duration of
26 weeks is enforced.
