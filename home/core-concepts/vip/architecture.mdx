...
Once the rewards each rollup receives for a given stage are known, these rewards are then
further distributed to the users of the rollup. The amount of VIP
