...
are then further distributed to the users of the rollup. The rollup team defines each user's VIP reward amount through a scoring
methodology. The scoring method could be based on factors such as:
