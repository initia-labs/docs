...
<Note>
We also recommend reviewing the [VIP Parameters](/resources/developer/initia-l1#vip-parameters) section for the current values of the parameters used in the VIP program.
</Note>
