...
During a stage, the snapshot of each rollup's INIT balance will also be taken
and used to determine the VIP [Balance Pool](/home/core-concepts/vip/architecture#balance-pool) rewards. There are two ways the
snapshot is done:
...
and the final rewards are distributed to the users.
