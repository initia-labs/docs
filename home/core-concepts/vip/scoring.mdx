...
4. Points may be allocated based on a user's usage of other rollups, provided that the usage is relevant and beneficial to the rollup conducting the scoring.  
...
Final approval for whitelisting rollups comes from Initia L1 governance through an on-chain vote. Any changes to a rollup's criteria must also be reviewed and approved by the VIP Committee before implementation.
