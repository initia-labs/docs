...
Finally, a portion of overall rewards is allocated directly to the rollups. This
ensures that rollup teams, rollup users, and INIT holders are long-term aligned
