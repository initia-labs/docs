...
Initia's Vested Interest Program (VIP) utilizes a scoring system to distribute `esINIT` rewards to users based on their activities on a given minitia. Each minitia will have its own self-determined scoring system.

## Whitelisting
For a minitia and its users to be eligible for VIP rewards, they first need to be whitelisted. This is done through a governance proposal on the Initia L1
