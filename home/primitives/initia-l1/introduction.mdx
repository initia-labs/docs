...
2. **Liquidity**: The [InitiaDEX](/home/core-concepts/initiadex) on L1 acts as a central liquidity hub for rollups, a platform for building and incentivizing token liquidity, and a facilitator for cross-rollup bridging and swaps.
...
4. **Incentives**: L1 powers various incentive schemes, including the [Vested Interest Program](/home/core-concepts/vested-interest-program) (VIP) which encourages user actions beneficial to rollup applications, and the Enshrined Liquidity program which incentivizes liquidity provision to InitiaDEX.
