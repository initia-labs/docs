...
-  **Query Native Slinky Oracle Price Data**: Retrieve price data from the native Slinky oracle.
...
-  **ERC20 Tokens Created on the Minitia**: Standard ERC20 tokens created within the Minitia rollup framework.
