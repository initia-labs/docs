...
RPC, and (for EVM rollups) JSON-RPC endpoints. The CLI also creates a magic
link that you can use to add your rollup to InitiaScan.
...
At this point, you can interact with your rollup, send transactions, and
deploy contracts. For full functionality, you also need to run the OPinit
Executor and Challenger bots and the IBC Relayer.
