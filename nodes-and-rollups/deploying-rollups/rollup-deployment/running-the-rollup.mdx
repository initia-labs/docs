...
<Tab title="l2_config">
This defines the configurations for the rollup being deployed.

| Field      | Description                                      | Example     |
|------------|--------------------------------------------------|-------------|
| `chain_id` | the chain ID of the rollup being deployed.      | rollup-1   |
| `denom`    | the base token denom to use for the rollup      | umin        |
