...
<Note>
  Before proceeding to create a validator, first make sure that your Initia node is fully synced to the latest height.
  You can verify this by comparing your node's latest block height with the network's.
</Note>
