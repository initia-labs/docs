...
To fully connect to the network, you first need to download the genesis file and configure your peers, and sync the node.
...
To sync the node, you can use the [state sync](https://github.com/tendermint/tendermint/blob/v0.34.x/spec/p2p/messages/state-sync.md) feature.
