...
<Warning>
  ...
  /.initia/config/priv_validator_key.json`. **IMPORTANT**: Always backup your
...
To fully connect to the network, you first need to download the genesis file and
configure your peers, and sync the node.

<Note>
  You can find information on the genesis file, peers, and state sync for the
  network you want to join in the [networks
